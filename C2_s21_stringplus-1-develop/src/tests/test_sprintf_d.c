...
START_TEST(sprintf_8_signed) {
  char str1[200];
  char str2[200];
  char *str3 = "%d Test %d Test %d TEST %d GOD %.d";
  int val = -3015;
  int val2 = -712;
  int val3 = -99;
  int val4 = -2939;
...
START_TEST(sprintf_9_signed) {
  char str1[200];
  char str2[200];
  char *str3 = "%+d Test %+3.1d Test %+5.7d TEST %+10d";
  int val = -3015;
  int val2 = -712;
  int val3 = -99;
  int val4 = -2939;
...
START_TEST(sprintf_12_signed) {
  char str1[200];
  char str2[200];
  char *str3 = "%+d Test %+3d Test %+5.7d TEST %+10d GOD %+d";
  int val = -32;
  int val2 = -8899;
  int val3 = 91918;
  int val4 = -32311;
...
START_TEST(sprintf_17_signed) {
  ...
  char str2[1024] = "";
  int val = -75;
  sprintf(str1, "Hello %d %d", val, val);
  s21_sprintf(str2, "Hello %d %d", val, val);
